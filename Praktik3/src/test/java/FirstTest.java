...
public class FirstTest {
    ...
    public void testUntitledTestCase() throws Exception {
        ...
        driver.findElement(By.id("input-card-holder")).sendKeys("MASHA IVANOVA");
        ...
        driver.findElement(By.id("input-card-cvc")).sendKeys("231");
        driver.findElement(By.xpath("//*[@id=\"action-submit\"]")).click();
        driver.findElement(By.xpath("//*[@id=\"success\"]")).click();
